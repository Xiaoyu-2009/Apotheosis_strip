...
public class ImprovedScrappingTomeItem extends ScrappingTomeItem {
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("info." + DivineCreation.MODID + ".improved_scrap_tome").withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("info." + DivineCreation.MODID + ".improved_scrap_tome2").withStyle(ChatFormatting.RED));
    }
